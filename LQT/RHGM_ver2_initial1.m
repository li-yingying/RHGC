...
% initialization is method 1: let z_{t+1}=theta_t^{Index}
% thetat, xit
% At 2:39pm May 5 2019: this is the correct version, old version RHGM.m is wrong


function [z, x,u, Cost,gradz,K, z_ini] = RHGM_ver2_initial1(A, B, W,  epsilon, beta, delta, gamma,  x0, Q, R, theta, xi,N)
